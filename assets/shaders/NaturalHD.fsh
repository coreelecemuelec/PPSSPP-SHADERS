...
#define Gsmoothing   9.5  	//Default: 3.5 /increase for smoother(blurry) graphics
//================
...
#define quality      2.00  	//Default: 0.99 /lower = smaller glow, better quality
...
#define Cpower       0.30	//Default: 0.10 /amount of effect mixed
//================
...
#define saturation   1.2  	//Default: 3.0 //negative will look like inverted colors shader
#define brightness   1.2  	//Default: 3.0
#define contrast     0.9  	//Default: 3.0 //negative will be... well negative;p
#define red          1.2  	//Default: 3.0
#define green        1.2 	//Default: 3.0
#define blue         1.3  	//Default: 3.0
...
#define SLcolor      4.7	//Default: 2.0 /brightens screen to compensate for dark lines
#define SLpower      3.0	//Default: 0.6 /less/more = darker/brighter lines, 
...
#define testAspeed   1.4 	//animation speed
//======================================================================================================================================================================
