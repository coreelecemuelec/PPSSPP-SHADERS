...
#define warna 1.3 //normal: 1.1
#define cerah 1.4 //normal: 1.0
#define kontras 0.9 //normal: 1.1
#define kemerahan 1.1 //normal: 1.1
#define kehijauan 1.0 //normal: 1.0
#define kebiruan 1.2 //normal: 1.0
