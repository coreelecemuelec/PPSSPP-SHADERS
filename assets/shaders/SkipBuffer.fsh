...
#define saturation   1.5  	//Default: 1.0 //negative will look like inverted colors shader
#define brightness   5.1  	//Default: 1.0
#define contrast     1.5  	//Default: 1.0 //negative will be... well negative;p
#define red          0.15   	//Default: 1.0
#define green        0.16  	//Default: 1.0
#define blue         0.22   	//Default: 1.0
