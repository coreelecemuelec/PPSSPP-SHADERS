//===========================//
//edit angka yang ada dibawah ini untuk 

#define warna 1.5 //normal: 1.0 
#define cerah 1.2 //normal: 1.0
#define kontras 0.8 //normal: 1.0
#define kemerahan 1.3 //normal: 1.0
#define kehijauan 1.3 //normal: 1.0
...
result = 1.0 - (1.0 - 2.0*(base-0.4)) * (1.0-blend);
return result;}
