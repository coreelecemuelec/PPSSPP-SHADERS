...
#define saturation   1.6  	//Default: 1.4 //negative will look like inverted colors shader
#define brightness   1.3  	//Default: 1.1
#define contrast     1.1  	//Default: 1.1 //negative will be... well negative;p
#define red          0.9   	//Default: 1.1
#define green        1.1  	//Default: 1.1
#define blue         1.3   	//Default: 1.4
...
int PSPCOLORS =      7; 	//Makes the colors as on older PSP screens(colder)
