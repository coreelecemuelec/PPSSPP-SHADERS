...
/*	                   	      .KX;    .dNKoON0;lXNkcld0NXo::cd0NNO:;,,'.. .0Xc            lXXo..'l0NNKd,.              .c0Nk,					       */																																															#define xz (
...
/*	                   	     .ONo    oNWWN0xXWK, .oNKc       .ONx.      ;X0.          .:XNKKNNWWWWNKkl;kNk. .cKXo.           .ON0;				       */
/*	                   	      .xNd   cNWWWWWWWWKOkKNXxl:,'...;0Xo'.....'lXK;...',:lxk0KNWWWWNNKOd:..   lXKclON0:            .xNk.				       */
/*	                   	      .dXd   ;XWWWWWWWWWWWWWWWWWWNNNNNWWNNNNNNNNNWWNNNNNNWWWWWNXKNNk;..        .dNWWXd.             cXO.				       */																																																																		#define yz )
/*	                   	      .xXo   .ONWNWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWNNK0ko:'..OXo          'l0NXx,              :KK,					       */
/*	                   	      .OXc    :XNk0NWXKNWWWWWWWWWWWWWWWWWWWWWNNNX00NNx:'..       lXKc.     'lONN0l.              .oXK:					       */
...
/*	                   	        .oKKkc,.                         .';cok0XNNNX0Oxoc,.										       */
/*	                   	         .;d0XX0kdlc:;,,,',,,;;:clodkO0KK0Okdl:,'..											       */	
/*	                   	              .,coxO0KXXXXXXXKK0OOxdoc:,..												       */																																															#define yy {
/*	                    	                       ...														       */
/*																					       */	
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/	                   	                                       
...
/*	                   	 oNNk,;c,'',.                      ...;xNNOc,.         ,d0X0xc,.     .dOd,           ..;dOKXK00000Ox:.   ..''dKO,			       */
/*	                   	'KW0,:,.,:..,oxkkkdl;'.                'KK'              ..           .dXX0o:'....,:oOXNN0d;.'. ..,lOKd.   .. ;KXl.			       */	
/*	                   	;XNd,;  ;. l00kxoooxKXKx:..ld:         ;KK'                             .:dkO000000Okxl;.   c0;      :KK;   .  ;XXc			       */																																																																																#define xw }
/*	                   	'XXdc.  :. ..    '' 'kNNNKKKk,      .,dKNO.                                   ....       .'c0NO'      :X0.  ,.  xN0.			       */	
/*	                   	.kNOc'  ,.      .00. ..''...      .l0X0d;.             'dOkxo;...                    .;okKXK0KNXx;.   .0X:  ,.  lNX'			       */
/*	                   	 ,KKdl  .c,    .dNK,            .;xXWKc.                .;:coOXO,,'.......       .,lx0XXOo;...oNWNXKk:.'KX;  '   dNX.			       */
/*	                   	  :XXkc'....  .dNWXl        .';l0NXNKl.          ,lxkkkxo' .cK0.          ..;lx0XNX0xc.     ,0Nx'.','.kXo  .,  ,KNx.			       */
...
#define Gsmoothing   0.21  	//Default: 3.5 /increase for smoother(blurry) graphics
//================
#define GAUSS_S      0		//ON:1/OFF:0 /simple gauss filtering by Bigpet, slightly different from above /you can find standalone in https://github.com/hrydgard/ppsspp/issues/7242
//================
#define EFFECT       0	//Aktifkan untuk menyalakan efek Tamvan dari Arashi!
//================
...
#define samples      2     	//Default: 4 /higher = more glow, worser performance
#define quality      0.05  	//Default: 0.25 /lower = smaller glow, better quality
#define factor       0.001 	//Default: 0.002 /just an extra tweak for the bloom slightly higher values might look better in some cases, but too much can cause artifacts
#define Bpower       0.05	//Default: 0.5 /amount of bloom mixed
//================
...
#define Cpower       0.11	//Default: 0.5 /amount of effect mixed
//================
#define SHARPEN      0    	//ON:1/OFF:0 /a simple sharpen filter, might be counterproductive to FXAA and BLOOM, hence disabled by default
#define value        0.05   	//Default: 7.5 /higher = more visible effect
//================
...
#define saturation   1.9  	//Default: 1.0 //negative will look like inverted colors shader
#define brightness   1.02  	//Default: 1.0
#define contrast     0.86  	//Default: 1.0 //negative will be... well negative;p
#define red          1.01   	//Default: 1.0
#define green        1.02  	//Default: 1.0
#define blue         1.03   	//Default: 1.0
...
#define	correction   1.1	//Default: 1.0
//================
