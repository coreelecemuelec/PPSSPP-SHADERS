...
#define quality      0.16  	//Default: 0.25 /lower = smaller glow, better quality
#define factor       0.000 	//Default: 0.002 /just an extra tweak for the bloom slightly higher values might look better in some cases, but too much can cause artifacts
#define Bpower       2.6	//Default: 0.5 /amount of bloom mixed
//================
...
#define brightness   0.7  	//Default: 1.0
...
#define	correction   0.5	//Default: 1.0
//======================================================================================================================================================================
