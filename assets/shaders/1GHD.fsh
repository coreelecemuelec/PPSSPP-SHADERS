...
#define Gsmoothing   3.3  	//Default: 3.5
//================
#define GAUSS_S      0		//ON:1/OFF:0
//================
#define MIKU         0		//Hatsune<3
//================
#define BLOOM        1     	//ON:1/OFF:0
#define samples      4     	//Default: 4
#define quality      99.25  	//Default: 0.25
#define factor       1.002 	//Default: 0.002
#define Bpower       9.0	//Default: 0.5
//================
#define COLORED      0     	//ON:1/OFF:0
#define Cpower       0.0	//Default: 0.5
//================
#define SHARPEN      0    	//ON:1/OFF:0
#define value        1.0   	//Default: 0.5
//================
#define S_COM_V2     0		 //Sharpen Complex v2
#define S_val0       0.0	 //Default: 5.0
//================
#define SHADEBOOST    1    	//ON:1/OFF:0
#define saturation   1.9  	//Default: 1.0
#define brightness   1.2  	//Default: 1.0
...
void main() {
  ...
  float FXAA_REDUCE_MUL = 8.8/8.0;
  float FXAA_REDUCE_MIN = (100.100/128.0);
