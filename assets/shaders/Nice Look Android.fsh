...
#define saturation   1.85  	//Default: 1.0 //negative will look like inverted colors shader

#define brightness   1.25  	//Default: 1.0

#define contrast     0.9  	//Default: 1.0 //negative will be... well negative;p

#define red          1.08   	//Default: 1.0

#define green        1.02  	//Default: 1.0

#define blue         1.02   	//Default: 1.0
