...
#define Gsmoothing   3.9  	//Default: 3.9 /increase for smoother(blurry) graphics
//================
...
#define saturation   1.1  	//Default: 1.2 //negative will look like inverted colors shader
#define brightness   1.3  	//Default: 1.1
#define contrast     1.1  	//Default: 1.2 //negative will be... well negative;p
#define red          1.1   	//Default: 1.1
#define green        1.2  	//Default: 1.1
#define blue         1.2   	//Default: 1.2
...
#define SLpower      0.7	//Default: 0.6 /less/more = darker/brighter lines, 
