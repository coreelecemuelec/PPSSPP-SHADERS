...
#define saturation   1.2  	//Default: 1.1 //negative will look like inverted colors shader
#define brightness   1.4  	//Default: 1.1
#define contrast     0.9  	//Default: 1.0 //negative will be... well negative;p
#define red          1.1   	//Default: 1.1
#define green        1.0  	//Default: 1.1
#define blue         1.2   	//Default: 1.1
