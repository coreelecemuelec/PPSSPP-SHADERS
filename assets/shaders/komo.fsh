...
#define saturation   1.9  	//Default: 2.0 //negative will look like inverted colors shader
#define brightness   1.5  	//Default: 2.0
#define contrast     0.8  	//Default: 2.0 //negative will be... well negative;p
#define red          1.1  	//Default: 2.0
#define green        1.1  	//Default: 2.0
#define blue         1.2   	//Default: 2.0
