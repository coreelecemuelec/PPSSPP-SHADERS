...
#define Gsmoothing   4.0  	//Default: 4.0 /increase for smoother(blurry) graphics
//================
...
#define saturation   1.3  	//Default: 1.2 //negative will look like inverted colors shader
#define brightness   1.3  	//Default: 1.4
#define contrast     1.0  	//Default: 1.2 //negative will be... well negative;p
#define red          1.0   	//Default: 1.1
#define green        1.1  	//Default: 1.2
#define blue         1.2   	//Default: 1.3
...
int PSPCOLORS =      5; 	//Makes the colors as on older PSP screens(colder)
...
#define	correction   1.2	//Default: 1.2
//================
...
#define SLpower      0.5	//Default: 0.5 /less/more = darker/brighter lines, 
