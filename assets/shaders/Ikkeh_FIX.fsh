...
#define quality      0.01  	//Default: 0.25 /lower = smaller glow, better quality
...
#define Bpower       0.2	//Default: 0.5 /amount of bloom mixed
//================
...
#define Cpower       0.72	//Default: 0.5 /amount of effect mixed
//================
#define SHARPEN      0    	//ON:1/OFF:0 /a simple sharpen filter, might be counterproductive to FXAA and BLOOM, hence disabled by default
#define value        0.45   	//Default: 7.5 /higher = more visible effect
//================
...
#define saturation   1.66  	//Default: 1.0 //negative will look like inverted colors shader
#define brightness   0.89  	//Default: 1.0
#define contrast     1.29  	//Default: 1.0 //negative will be... well negative;p
#define red          1.02   	//Default: 1.0
#define green        1.03  	//Default: 1.0
#define blue         1.01   	//Default: 1.0
...
#define	correction   0.96	//Default: 1.0
//================
...
#define SLcolor      5.2	//Default: 2.8 /brightens screen to compensate for dark lines
#define SLpower      0.6	//Default: 0.4 /less/more = darker/brighter lines, 
