...
#define value        1.2   	//Default: 7.5 /higher = more visible effect
//================
#define S_COM_V2     0		//Sharpen Complex v2 from https://github.com/mpc-hc similar to above in effect, maybe more accurate
#define S_val0       2.0	//Default: 5.0 /higher ~ increases sharpness /negative ~ can add extra blurr/strange effect
//================
...
#define saturation   1.25  	//Default: 1.0 //negative will look like inverted colors shader
#define brightness   1.04  	//Default: 1.0
#define contrast     1.11  	//Default: 1.0 //negative will be... well negative;p
#define red          1.0   	//Default: 1.0
#define green        1.2  	//Default: 1.0
...
#define testAspeed   2.0 	//animation speed
//======================================================================================================================================================================
