...
#define value        14.8   	//Default: 10.8 /higher = more visible effect
//================
...
#define saturation   1.75  	//Default: 3.0 //negative will look like inverted colors shader
#define brightness   3.0  	//Default: 3.0
#define contrast     1.09  	//Default: 3.0 //negative will be... well negative;p
#define red          0.24  	//Default: 3.0
#define green        0.33 	//Default: 3.0
#define blue         0.42  	//Default: 3.0
