...
#define saturation   1.75   	//Default: 1.0 //negative will look like inverted colors shader
#define brightness   3.0   	//Default: 1.0
#define contrast     1.0   	//Default: 1.0 //negative will be... well negative;p
#define red          0.28   	//Default: 1.0
#define green        0.37   	//Default: 1.0
#define blue         0.45   	//Default: 1.0
...
#define vsize        1.6   	//Default: 1.2 /winter... I mean darkness is coming ~ with higher values
