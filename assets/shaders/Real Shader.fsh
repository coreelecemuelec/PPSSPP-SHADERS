...
#define samples      4     	//Default: 4 /higher = more glow, worse performance
#define quality      0.18  	//Default: 0.18 /lower = smaller glow, better quality
